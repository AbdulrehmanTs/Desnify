      ...
      >
        ...
        <div className="relative z-10 max-w-lg sm:max-w-md md:max-w-5xl px-4 flex flex-col items-center text-center">
          ...
          <p className="max-w-lg sm:max-w-4xl mt-4 text-gray-700 text-[20px] font-[Dm_Sans] font-normal leading-8 tracking-[0%] text-center">
            Desnify is an AI-powered e-commerce platform for custom T-shirt
            designs. Browse unique styles or let our AI generate personalized
            designs based on your preferences. Whether you&apos;re looking for
            something trendy or totally unique, Desnify makes customizing
            T-shirts simple and fun. Start creating your perfect T-shirt today!
          </p>
        </div>
      </div>
    </div>
