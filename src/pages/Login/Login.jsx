...
//                     <h2 className="text-5xl font-bold mb-4 text-black font-[Inter]">Login</h2>
//                     <p className="text-[#818181] font-[Inter] font-normal text-[16px] mb-6 leading-5">Login your account in a seconds</p>

//                     <form>


//                         <label className="block text-[#818181] font-[Inter] font-extrabold leading-5 text-[16px] ml-1.5">Email Address:</label>
//                         <input
//                             type="email"
...
//                         <label className="block text-[#818181] font-[Inter] font-extrabold leading-5 text-[16px] ml-1.5">Password:</label>
//                         <input
//                             type="password"
//                             placeholder="********"
//                             className="w-full p-4 border border-[#D1D1D1] rounded-2xl mb-4 mt-2 bg-white"
...
//                             <p className="text-gray-700 mt-2 sm:mt-0">Forgot Password?</p>
//                         </div>


//                         <button className="w-full bg-green-600 text-white p-3 rounded-md font-semibold hover:bg-green-700">
//                             Log In
//                         </button>
//                     </form>

//                     <p className="text-center text-gray-600 mt-4">
//                         Don't have an account? <a href="/signin"><span className="text-green-600 font-bold cursor-pointer">Sign up</span></a>
//                     </p>
//                 </div>
//             </div>
//         </div>
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(response.status === 200 && formData.email ==="desnifyadmin@yopmail.com"){
