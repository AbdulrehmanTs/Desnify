...
//     return (
//         <header className="flex justify-between flex-wrap gap-2 p-4 bg-white shadow">
//             <div className="flex items-center gap-2">
//                 {/* Could include logo or left content if needed */}
//             </div>
//             <div className="flex items-center gap-4 flex-wrap">
//                 <Search onClick={() => setDisplaySearch(!displaySearch)} size={20} />
//                 {displaySearch && (
//                     <input
//                         type="text"
//                         placeholder="Search..."
...
//                 )}
//                 <Bell size={24} />
//                 <button className="border border-[#1C1C1A] py-2 px-4 flex items-center gap-1 rounded-[8px]">
//                     Admin <ChevronDown />
//                 </button>
//             </div>
//         </header>
...
const Header = () => {
    ...
    return (
        <header className="flex justify-between items-center flex-wrap gap-2 p-4 bg-white shadow">
            <div className="flex items-center gap-2">{/* Logo or left content */}</div>
