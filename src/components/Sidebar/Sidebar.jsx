    ...
    <div className=" p-6 ">
      ...
      <div className="border border-[#E2E2E2] p-4 mb-6  shadow-md">
        <h2 className="text-lg font-semibold flex items-center ">
          <span className="border-l-2 border-[#2D2D2D] pl-2 text-[#2D2D2D] font-[Oxygen] font-normal text-[22px] leading-7 ">Categories</span>
        </h2>
        <ul className="mt-2">
      ...
      <div className="border border-[#E2E2E2] p-4 mb-6  shadow-md min-h-72 py-8 space-y-8 ">
        <h2 className="text-lg font-semibold flex items-center">
          <span className="border-l-2 border-[#2D2D2D] pl-2 text-[#2D2D2D] font-[Oxygen] font-normal text-[22px] leading-7">Price Range</span>
        </h2>
        <div className="mt-4 space-y-4">
          {["$20.00 - $50.00", "$20.00 - $50.00", "$20.00 - $50.00", "$20.00 - $50.00"].map(
            (price, index) => (
              <label key={index} className="flex items-center space-x-2">
                ...
                />
                <span className="text-[#414141] font-[Oxygen] font-normal text-[16px] leading-7">{price}</span>
              </label>
            )
          )}
        </div>
